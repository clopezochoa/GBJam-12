...
/** @type {string} */
const CACHE_VERSION = '1727025363|23733618435';
/** @type {string} */
const CACHE_PREFIX = 'Gb Jam-12-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Gb Jam-12.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Gb Jam-12.html","Gb Jam-12.js","Gb Jam-12.offline.html","Gb Jam-12.icon.png","Gb Jam-12.apple-touch-icon.png","Gb Jam-12.worker.js","Gb Jam-12.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Gb Jam-12.wasm","Gb Jam-12.pck"];
