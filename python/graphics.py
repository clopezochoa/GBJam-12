...
def generate_background(curve_intensity, fade_depth, horizon_height, ground_color, sky_color):
...
def create_animation(curve_intensity, fade_depth, horizon_height, ground_color, sky_color, leveling_factor):
    ...
    for i in range(num_frames):
        ...
        images.append(generate_background(curve_variation, fade_depth, horizon_height, ground_color, sky_color))
